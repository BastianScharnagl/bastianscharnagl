                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8 text-center md:text-left">
                        <div className="flex flex-col md:flex-row items-center md:items-end gap-6">
                            ...
                            <div className="flex items-center gap-3 mb-4 justify-center md:justify-start">
                                <span className="px-3 py-1 bg-blue-500/10 text-blue-600 dark:text-blue-400 text-xs font-bold uppercase tracking-widest rounded-full">Investor Profile</span>
                            </div>
                                <h1 className="text-4xl md:text-6xl font-bold mb-4">
                                    Life creating <span className="text-blue-500">Value</span>
                                </h1>
                            </div>
                        </div>
                    </div>
